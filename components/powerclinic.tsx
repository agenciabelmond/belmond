  ...
  return (
    <section className="relative bg-black text-white py-20 px-6 md:px-12 lg:px-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <h2
        className="text-4xl md:text-5xl lg:text-6xl font-serif italic text-white text-center mb-10 text-balance"
        style={{
            textShadow: "0 0 20px rgba(233, 210, 166, 0.5), 0 0 40px rgba(233, 210, 166, 0.3)",
        }}
        >
