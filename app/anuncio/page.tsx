...
export default function Home() { import { useEffect } from "react"
  ...
  return ( return (
    <main className="min-h-screen bg-black text-white flex flex-col selection:bg-yellow-500/20">
      ...
      <section className="flex flex-1 items-center justify-center bg-gradient-to-b from-black to-zinc-950 px-6 py-20">
        ...
        >
          <p className="mb-5 text-sm font-medium uppercase tracking-[0.2em] text-[#d4af37] md:text-base">
          ...
          <h1 className="mb-6 text-4xl font-semibold leading-tight md:text-6xl">
            Marketing odontológico com foco em crescimento real
          </h1>

          <p className="mx-auto max-w-2xl text-base leading-relaxed text-zinc-400 md:text-lg">
            Ajudamos clínicas odontológicas a aumentar faturamento, melhorar processos
            internos e construir uma presença digital que gera pacientes todos os dias.
          </p>
